...
(function () {
    WinJS.UI.Pages.define("./pages/search/search.html", {
        ...
        _suggestionsRequestedHandler: function (eventObject) {
            var queryText = eventObject.detail.queryText, query = queryText.toLowerCase(), suggestionCollection = eventObject.detail.searchSuggestionCollection;
        ...
        _handleFilterChanged: function (e) {
            ...
            switch (target.winControl.id) {
                case "featured":
                    Store.Data.sortingFunc = function (a, b) { return a.featured ? -1 : (b.featured ? 1 : 0); };
                    break;
                case "mostReviews":
                    Store.Data.sortingFunc = function (a, b) { return a.reviews.length > b.reviews.length ? -1 : (a.reviews.length === b.reviews.length ? 0 : 1); };
                    break;
                case "price":
                    Store.Data.sortingFunc = function (a, b) { return a.price < b.price ? -1 : (a.price === b.price ? 0 : 1); };
                    break;
                case "priceDesc":
                    Store.Data.sortingFunc = function (a, b) { return a.price < b.price ? 1 : (a.price === b.price ? 0 : -1); };
                    break;
                case "ratings":
                    Store.Data.sortingFunc = function (a, b) { return a.ratingAvg < b.ratingAvg ? 1 : (a.ratingAvg === b.ratingAvg ? 0 : -1); };
                    break;
                case "ratingsDesc":
                    Store.Data.sortingFunc = function (a, b) { return a.ratingAvg < b.ratingAvg ? -1 : (a.ratingAvg === b.ratingAvg ? 0 : 1); };
                    break;
